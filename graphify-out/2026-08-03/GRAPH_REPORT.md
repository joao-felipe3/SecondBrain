# Graph Report - SecondBrain (2026-08-03)

## Corpus Check

- 612 files · ~7,061,902 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 4732 nodes · 10327 edges · 259 communities (223 shown, 36 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.6)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `834491a5`
...
Cohesion: 0.06
Nodes (45): PromptBuilderService, Injectable, Inject, WBSNodeDto, WBSLeafProjectContext, ApplyRebaselineFixParams, ApplySimplifyFixParams, AuditLeafDiscrepancyParams (+37 more)

### Community 1 - "tasks.module.ts"

Cohesion: 0.06
Nodes (29): InjectModel, GanttDataResponse, ResolveWindowParams, InjectModel, DashboardMetricPreferences, ProjectDocument, SmartObjective, ProjectStatsService (+21 more)
...
### Community 3 - "gemini.service.ts"

Cohesion: 0.21
Nodes (13): RequirementMaps, RTMMatrixData, RTMRequirementData, RTMTaskData, RTMValidation, ValidationIssues, RequirementMapper, JourneyKind (+5 more)

### Community 4 - "CreateTaskDto"

Cohesion: 0.10
Nodes (10): CalculateProgressDto, CreateManyTasksOptionsDto, IsBoolean, IsOptional, CreateTaskDto, TasksMetricsService, Injectable, TasksWriteService (+2 more)
...
### Community 6 - "buffer.service.ts"

Cohesion: 0.07
Nodes (29): ApiOperation, ApiResponse, Body, Get, Param, Post, BufferHistoryDto, CalculateBufferDto (+21 more)
...
### Community 8 - "evm.service.ts"

Cohesion: 0.16
Nodes (22): EVMActiveWaveContextDto, EVMCoreMetricsDto, EVMCurve, EVMForecast, EVMMilestoneProgress, EVMPersonalSummaryDto, EVMSummary, EVMService (+14 more)

### Community 9 - "task.schema.ts"

Cohesion: 0.10
Nodes (16): ProjectsService, Injectable, InsertManyError, TaskChecklistItem, TaskRecurringRule, InjectModel, ChecklistService, Injectable (+8 more)

### Community 10 - "ChecklistAiService"

Cohesion: 0.20
Nodes (7): ChecklistPromptParams, ChecklistWithHistoryPromptParams, buildChecklistGenerationPrompt(), buildChecklistWithHistoryPrompt(), ChecklistAiService, Inject, Injectable

### Community 11 - "MicroTaskDraft"
...
Cohesion: 0.07
Nodes (43): buildCatchballQuestionsPrompt(), buildSmartObjectivePrompt(), buildSuggestAnswerPrompt(), CreateProjectDto, CatchballRequestDto, CatchballResponseDto, PlanWithAIResponseDto, RefineObjectiveDto (+35 more)
...
### Community 14 - "cpm-diagnostics.dto.ts"
...
Cohesion: 0.07
Nodes (20): buildAuditPrompt(), buildWbsDecompositionPrompt(), buildWbsGenerationPrompt(), Injectable, WbsAiService, ValidateWBSResponseDto, AuditLeafDiscrepancyAiInput, AuditLeafDiscrepancyAiResult (+12 more)
...
Cohesion: 0.14
Nodes (16): CreateDependencyDto, ApiProperty, IsBoolean, IsNotEmpty, IsOptional, IsString, TaskDependency, TaskDependencyMapper (+8 more)
...
Cohesion: 0.10
Nodes (15): FindSimilarTasksDto, GenerateChecklistDto, GenerateChecklistWithHistoryDto, ApiProperty, IsBoolean, IsNotEmpty, IsNumber, IsOptional (+7 more)
...
Cohesion: 0.08
Nodes (22): openModal(), allBookGroups, bookColors, projectBookGroups, props, usePertDiagramState(), usePertGraphTopology(), useProjectDelete() (+14 more)

### Community 28 - "PertAiService"

Cohesion: 0.18
Nodes (5): PertEstimatePromptParams, buildPertEstimatePrompt(), PertAiService, Inject, Injectable
...
Cohesion: 0.05
Nodes (36): emit, emit, activeTasksCount, completedTasksCount, isOpen, projectStore, streakDays, taskStore (+28 more)

### Community 34 - "cpm.interface.ts"
...
Cohesion: 0.11
Nodes (10): Requirement, RequirementDocument, InjectModel, InjectModel, Inject, InjectModel, RTMValidationService, Injectable (+2 more)
...
Cohesion: 0.08
Nodes (19): useTaskHelpers(), activeIcon, allTasks, api, { createNewTask }, habitsDueToday, habitsDueTodayCount, isMobile (+11 more)
...
### Community 52 - "GeminiService"

Cohesion: 0.07
Nodes (34): buildRiskAssessmentPrompt(), GeminiService, Injectable, Inject, IDepRecord, ITaskRecord, RecordProjectProgressDto, IsDateString (+26 more)

### Community 53 - "TasksHierarchyService"
...
Cohesion: 0.13
Nodes (12): MapRequirementToTaskDto, PreparedRequirementDataDto, ProcessSingleRequirementDto, RTMValidationDto, SaveRequirementDto, ApiProperty, ApiPropertyOptional, IsNotEmpty (+4 more)
...
Cohesion: 0.08
Nodes (10): InjectModel, TaskDocument, TasksHabitsService, Injectable, InjectModel, TasksCompletionService, Injectable, TasksService (+2 more)
...
### Community 60 - "cpm-analysis.utils.ts"

Cohesion: 0.14
Nodes (23): GroupedPackageTasks, RawPackageMetrics, generateAlerts(), calculateCriticalPath(), calculateSlacksAndCriticalTasks(), computeGraphDegrees(), createCPMDiagnostics(), executeCPMPasses() (+15 more)
...
### Community 63 - "ai.module.ts"

Cohesion: 0.09
Nodes (15): AIModule, Module, CompletionFeedbackPromptParams, NextStepsPromptParams, TaskSuggestionsPromptParams, buildCompletionFeedbackPrompt(), buildGeminiNextStepsPrompt(), buildTaskSuggestionsPrompt() (+7 more)
...
Cohesion: 0.05
Nodes (35): HandleEmptyGraphParams, PertResolvedLayoutMode, usePertEmptyGraphHandler(), usePertGeometryOptimizer(), BindPertGraphEventsParams, usePertGraphEventBindings(), InitializePertGraphParams, InitializePertGraphResult (+27 more)
...
Cohesion: 0.11
Nodes (21): buildFixMonotonyPrompt(), ApplyGuardrailsParams, AuditLeafDiscrepancyInput, LeafAuditResult, BatchMetricInputTask, BatchMetricsOptions, BatchMetricsResult, ChunkMinutesParams (+13 more)
...
Cohesion: 0.16
Nodes (22): GanttDependencyItem, GanttQueryOptions, GanttTaskItem, GanttTimeWindow, AdjustWindowBoundsParams, BuildTaskNodesParams, EffectiveEndParams, MapSingleTaskItemParams (+14 more)
...
### Community 88 - "rtm-crud.service.ts"

Cohesion: 0.23
Nodes (11): applyFallbackMapping(), formatTasksForPrompt(), JourneyDraft, normalizeGeneratedItems(), processMappingResponse(), RawMappingEntry, safeStringify(), levelForKind() (+3 more)
...
### Community 97 - "GeneralInfoPage.vue"

Cohesion: 0.40
Nodes (5): emit, emitField(), local, Project, props

### Community 98 - "ProgressBar.vue"
...
### Community 100 - "pert-helpers.util.ts"
...
Cohesion: 0.10
Nodes (27): BuildEVMCurvePointsParamsDto, BuildPersonalMetricsParamsDto, EstimateCompletionDateParamsDto, EVMDashboardManualVisibility, EVMDashboardPreferences, EVMDashboardPreferencesInput, EVMMetricRelevance, EVMMetricVisibility (+19 more)
...
### Community 107 - "rolling-wave-ai.service.ts"
...
Cohesion: 0.06
Nodes (19): GenerateWbsInput, WBSNodeDocument, Inject, RawWBSNode, Injectable, WbsGenerationService, Injectable, InjectModel (+11 more)
...
Cohesion: 0.21
Nodes (7): buildAutoMapBatchPrompt(), buildGenerateRequirementsPrompt(), buildGenerateTasksPrompt(), GenerateTasksResponseDto, RTMTaskGeneratorService, safeStringify(), Injectable
...
Cohesion: 0.05
Nodes (40): AppModule, Module, MongooseLoggerInterceptor, Injectable, ProjectsModule, Module, IsBoolean, IsNumber (+32 more)
...
Cohesion: 0.17
Nodes (8): emit, GoldPopup, goldPopups, isDaggerShaking, { playCoinsSound, playDaggerSound }, isAmbientPlaying, isMuted, useGuildAudio()
...
### Community 125 - "pert/usePertDiagramData.ts"
...
### Community 136 - "DraftPlanGenerationService"
...
### Community 143 - "HabitTimelineTab.vue"
...
### Community 163 - "RequirementType"

Cohesion: 0.26
Nodes (5): RequirementType, RTMAiService, Injectable, RTMJourneyService, Injectable
...
### Community 168 - "FiltersPanel.vue"

Cohesion: 0.20
Nodes (11): clearFilters(), emit, emitChanges(), Emits, localPriorityFilter, localProjectFilter, localTypeFilter, priorityItems (+3 more)
...
### Community 177 - "rolling-wave-db-helpers.util.ts"
...
### Community 188 - "applySimplifyToTargetHours"
...
### Community 199 - "sendHabitBrowserNotifications"

Cohesion: 0.20
Nodes (10): notification, canSendBrowserNotifications(), enableHabitNotifications(), getTodayKey(), handleTaskCreated(), handleTaskMoved(), readHabitNotificationLog(), refreshHabitsDashboard() (+2 more)
...
Cohesion: 0.09
Nodes (23): Project, DeterministicProjectInput, ProjectProgressSchema, ProjectSchema, ProjectWave, ProjectWaveDocument, ProjectWaveSchema, Prop (+15 more)
...
### Community 250 - "usePertRenderFailureState.ts"
...
- **1416 isolated node(s):** `$schema`, `collection`, `sourceRoot`, `deleteOutDir`, `name` (+1411 more)
...
- **Why does `GeminiService` connect `GeminiService` to `WBSNodeDto`, `gemini.service.ts`, `Requirement`, `feedback.service.ts`, `GeminiExecutorService`, `ChecklistAiService`, `MicroTaskDraft`, `rolling-wave-ai.service.ts`, `projects.controller.ts`, `wbs/index.ts`, `wbs-ai.service.ts`, `task.schema.ts`, `tasks.service.ts`, `DependencyInferenceService`, `ai-suggestions-runner.service.ts`, `TaskDocument`, `PertAiService`, `ai.module.ts`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `TaskDocument` connect `TaskDocument` to `tasks.module.ts`, `x-matrix-helpers.util.ts`, `CreateTaskDto`, `task.schema.ts`, `projects.controller.ts`, `tasks.controller.ts`, `tasks.service.ts`, `AlertsService`, `ChecklistOperationsService`, `ai-suggestions-runner.service.ts`, `Task`, `feedback.service.ts`, `TasksRecurringService`, `PertEstimateDto`, `TasksHierarchyService`, `ai.module.ts`, `projects.module.ts`, `gantt-helpers.util.ts`, `rolling-wave.interface.ts`, `pert-helpers.util.ts`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `Task` connect `Task` to `WBSNodeDto`, `tasks.module.ts`, `gemini.service.ts`, `Requirement`, `wbs-conversion-orchestrator.service.ts`, `CPMController`, `projects.controller.ts`, `projects.module.ts`, `tasks.service.ts`, `RTMMappingService`, `rtm-crud.service.ts`?**
...
- **Should `tasks.module.ts` be split into smaller, more focused modules?**
