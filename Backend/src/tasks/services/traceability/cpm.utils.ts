...
import {
  ...
  backwardPass,
  buildEdgeMap,
} from './cpm-passes.utils';

// Re-export relationship normalizer for backwards compatibility
...
export function computePackageCriticality(tasks: TaskNode[], criticalPath: string[]): PackageCriticality[] {
