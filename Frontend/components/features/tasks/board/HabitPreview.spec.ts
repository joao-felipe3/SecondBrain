...
describe('Sprint 5: HabitPreview Component', () => {
  ...
  describe('Habit Type Detection', () => {
    ...
    it('should not detect regular task as habit', () => {
      ...
      const isHabit = task.microTaskType === 'habit' || !!task.parentRecurringId || !!task.recurringRule
  ...
  describe('Streak Display', () => {
    ...
    it('should display longest streak', () => {
      ...
      expect(mockHabit.streakData.longestStreak).toBeGreaterThanOrEqual(mockHabit.streakData.currentStreak)
    })

    it('should handle zero streak', () => {
      const habit = { ...mockHabit, streakData: { currentStreak: 0, aderencePercent: 0 } }
  ...
  describe('Habit Actions Integration', () => {
    ...
    it('should emit complete-habit event when handleComplete is called', async () => {
      ...
      expect(taskStoreMock.handleRecurringCompletion).toHaveBeenCalledWith(habitId)
    })
    ...
    it('should handle completion errors gracefully', async () => {
      ...
      const result = await taskStoreMock.handleRecurringCompletion('nonexistent-id')
  ...
  describe('KanbanBoard Integration', () => {
    it('should render habit in kanban grid alongside regular tasks', () => {
      const tasks = [
        ...
        { _id: 'habit-1', name: 'Morning Meditation', microTaskType: 'habit', status: 'todo' },
      ]
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle habit with very high streaks', () => {
      const habit = { ...mockHabit, streakData: { currentStreak: 365, longestStreak: 365, aderencePercent: 100 } }
